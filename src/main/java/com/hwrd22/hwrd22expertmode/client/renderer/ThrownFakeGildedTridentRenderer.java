...
public class ThrownFakeGildedTridentRenderer extends EntityRenderer<ThrownFakeGildedTrident> {
    ...
    public void render(ThrownFakeGildedTrident p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, @NotNull MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ThrownFakeGildedTrident p_114482_) {
        return TEXTURE;
    }
}
