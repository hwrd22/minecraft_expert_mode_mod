...
public class LightningBallRenderer extends EntityRenderer<LightningBall> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(ExpertMode.MODID, "textures/entity/lightning_ball.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public LightningBallRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }
