...
public class ThrownGildedTridentRenderer extends EntityRenderer<ThrownGildedTrident> {
    ...
    public void render(ThrownGildedTrident p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(ThrownGildedTrident p_114482_) {
        return TEXTURE;
    }
}
