...
@OnlyIn(Dist.CLIENT)
public class ThrownGildedTridentRenderer extends EntityRenderer<ThrownGildedTrident> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ExpertMode.MODID, "textures/entity/gilded_trident.png");
    private final ThrownGildedTridentModel model;
    public ThrownGildedTridentRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new ThrownGildedTridentModel(context.bakeLayer(ThrownGildedTridentModel.LAYER_LOCATION));
    }

    public void render(ThrownGildedTrident p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, @NotNull MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ThrownGildedTrident p_114482_) {
        return TEXTURE;
    }
}
