...
public class ThrownPoseidonTridentModel<T extends ThrownPoseidonTrident> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ExpertMode.MODID, "poseidon_trident"), "main");
    private final ModelPart bone;

    public ThrownPoseidonTridentModel(ModelPart root) {
