...
import com.hwrd22.hwrd22expertmode.entity.projectile.LightningBall;
...
public class LightningStaffItem extends ProjectileWeaponItem implements Vanishable {
    public LightningStaffItem(Properties p_43009_) {
        super(p_43009_);
    }
    ...
    public void releaseUsing(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
        ...
        if(!((double)f < 0.10)) {
            ...
            p_40668_.playSound((Player)null, p_40669_.getX(), p_40669_.getY(), p_40669_.getZ(), ModSounds.LIGHTNING_CAST.get(), SoundSource.PLAYERS, 0.5f, 1.0f);
        }
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        p_41423_.add(Component.literal("Fires a ball of lightning that will spawn a Lightning Bolt where it lands.\nDoes not activate the Copper Armor's set bonus.").withStyle(ChatFormatting.YELLOW, ChatFormatting.ITALIC));
