...
public class FakeGildedTridentItem extends TridentItem {
    public FakeGildedTridentItem(Properties p_43381_) {
        super(p_43381_);
    }
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        p_41423_.add(Component.literal("It's a fake. Not much better than a normal Trident.").withStyle(ChatFormatting.YELLOW, ChatFormatting.ITALIC));
